...
<script type="text/javascript">
	...
	function del(id,name)
	{
		if(window.confirm("确认删除用户："+name))
			{
		location.href ="${pageContext.request.contextPath }/user/delete?operator_id="+id;
			}
	}
</script>
</head>
<body bgcolor="#77cc77">
	<div align="center">
		<p align="left">
			<a href="#"
				onclick="myOpen('${pageContext.request.contextPath }/user/add')">创建用户</a>
		</p>
		<form action="${pageContext.request.contextPath }/user/statusName"
			method="post">
		...
		<table width="640" border="0">
			...
			<c:forEach items="${us}" var="u">
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath }/user/update?operator_id=${u.operator_id}">修改</a></td>
