...
<body>
<div align="center">
<form action="${pageContext.request.contextPath}/userbj/update"  method="post">
<table class="table table-bordered">
<tr>
<td>ID:</td>
<td><input type="text"  name="reasonId"  value="${m.reasonId}" readonly="readonly"/></td>
</tr>
<tr>
<td>报警类型:</td> 
...
/userbj/alarm" method="post">返回</a></td>
</tr>
</table>
</form>
</div>
