...
<body>
<h3 style="margin: 30px;">新增用户组</h3>

<hr size="2" color="black" />


<form action="${pageContext.request.contextPath}/cont/add" method="post">

  <div class="form-group">
    <label for="groupName" >组名称：</label>
  
    <input type="text" class="form-control" placeholder="角色名称" name="groupName">
    
  </div>
  <div class="form-group">
    <label for="describeGroup" >组描述：</label>
    
     <input type="text" class="form-control" name="describeGroup">
