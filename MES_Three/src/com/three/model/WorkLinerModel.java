...
public class WorkLinerModel {
	...
	public String toString() {
		return "sysWorkLinerModel [LinerId=" + LinerId + ", LinerName=" + LinerName + ", LinerAdmin=" + LinerAdmin
				+ ", ShopId=" + ShopId + "]";
	}

	public WorkLinerModel() {
		super();
		// TODO Auto-generated constructor stub
	}

	public WorkLinerModel(Integer linerId, String linerName, String linerAdmin, Integer shopId) {
		super();
		LinerId = linerId;
		LinerName = linerName;
		LinerAdmin = linerAdmin;
	...
	public WorkLinerModel(String linerName, String linerAdmin, Integer shopId) {
		super();
		LinerName = linerName;
		LinerAdmin = linerAdmin;
		ShopId = shopId;
