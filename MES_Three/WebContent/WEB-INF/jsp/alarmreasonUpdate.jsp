...
<body>
	<div align="center">
		<h4>
			<font color="lightblue">修改报警原因</font>
		</h4>
	</div>
	<div align="center">
		<form
			action="${pageContext.request.contextPath }/alarmreason/doUpdate"
			method="post">
			<table border="0" height="200">
				<tr>
					<td>序号</td>
					<td><input type="text" name="reasonId" value="${a.reasonId }" /></td>
				</tr>
				<tr>
					<td>所属报警类型</td>
